...
const {
  searchFilterInternships,
  bookmarkInternship,
  getBookmarkedInternships,
  searchBookmarkedInternship,
...
const {
  searchFilterFreshersJobs,
  bookmarkFresherJob,
  getBookmarkedFresherJobs,
  searchBookmarkedFresherJob,
} = require("../controller/freshersjob");

const {
  apply,
  student_getPendingApplications,
  student_getApprovedApplications,
  student_getRejectedApplications,
