(function (global, factory) {
  ...
  */
  ...
  var createMethod = function (TYPE) {
    ...
    return function ($this, callbackfn, that, specificCreate) {
      ...
      var target = IS_MAP ? create($this, length) : TYPE == 2 || TYPE == 7 ? create($this, 0) : undefined;
      var value, result;
  ...
  function _iterableToArray(iter) {
    if (typeof symbol$4 !== "undefined" && isIterable$1(Object(iter))) return from$4(iter);
  }
  ...
  function getLabels$1(container, element, _temp) {
    ...
    return labelsId.length ? labelsId.map(function (labelId) {
      ...
      var labelledFormControl = Array.from(label.querySelectorAll('button, input, meter, output, progress, select, textarea')).filter(function (formControlElement) {
  ...
  function getSuggestedQuery(element, variant, method) {
    ...
    var testId = element.getAttribute(getConfig$1().testIdAttribute);
  ...
  function waitFor(callback, _ref) {
    var _ref$container = _ref.container,
        ...
        timeout = _ref$timeout === void 0 ? getConfig$1().asyncUtilTimeout : _ref$timeout,
        _ref$showOriginalStac = _ref.showOriginalStackTrace,
        showOriginalStackTrace = _ref$showOriginalStac === void 0 ? getConfig$1().showOriginalStackTrace : _ref$showOriginalStac,
      ...
      error.message = getConfig$1().getElementError(error.message, container).message;
      return error;
    } : _ref$onTimeout,
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(resolve, reject) {
        var lastError, intervalId, observer, finished, promiseStatus, overallTimeoutTimer, usingFakeTimers, error, _getWindowFromNode, MutationObserver, onDone, checkRealTimersCallback, checkCallback, handleTimeout;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                checkRealTimersCallback = function () {
  ...
  function waitForWrapper(callback, options) {
    ...
    return getConfig$1().asyncWrapper(function () {
  ...
  */
  ...
  function makeGetAllQuery(allQuery, getMissingError) {
    return function (container) {
      ...
      if (!els.length) {
        throw getConfig$1().getElementError(getMissingError.apply(void 0, [container].concat(args)), container);
      }
  ...
  var wrapSingleQueryWithSuggestion = function (query, queryAllByName, variant) {
    return function (container) {
      ...
      var _args$slice$$suggest = _args$slice$.suggest,
          suggest = _args$slice$$suggest === void 0 ? getConfig$1().throwSuggestions : _args$slice$$suggest;
  ...
  var wrapAllByQueryWithSuggestion = function (query, queryAllByName, variant) {
    return function (container) {
      ...
      var _args$slice2$$suggest = _args$slice2$.suggest,
          suggest = _args$slice2$$suggest === void 0 ? getConfig$1().throwSuggestions : _args$slice2$$suggest;
  ...
  var getAllByLabelText = function (container, text) {
    ...
    if (!els.length) {
      ...
      if (labels.length) {
        ...
        if (tagNames.length) {
          throw getConfig$1().getElementError(tagNames.map(function (tagName) {
  ...
  function queryAllByRole(container, role, _temp) {
    var _ref = _temp === void 0 ? {} : _temp,
        ...
        hidden = _ref$hidden === void 0 ? getConfig$1().defaultHidden : _ref$hidden,
        name = _ref.name,
        trim = _ref.trim,
        normalizer = _ref.normalizer,
  ...
  var getMissingError$5 = function (container, role, _temp3) {
    var _ref3 = _temp3 === void 0 ? {} : _temp3,
        ...
        hidden = _ref3$hidden === void 0 ? getConfig$1().defaultHidden : _ref3$hidden,
        name = _ref3.name;
  ...
  var getTestIdAttribute = function () {
    return getConfig$1().testIdAttribute;
  };
  ...
  */
  ...
  function fireEvent(element, event) {
    return getConfig$1().eventWrapper(function () {
      if (!event) {
  ...
  function actPolyfill(cb) {
    ...
    ReactDOM__default['default'].render( /*#__PURE__*/React.createElement("div", null), document.createElement('div'));
  }
